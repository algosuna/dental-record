...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HistogramaItem.estimado'
        db.alter_column('historialprocedimientos_histogramaitem', 'estimado', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'HistogramaItem.finalizado'
        db.alter_column('historialprocedimientos_histogramaitem', 'finalizado', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Renaming column for 'HistogramaItem.inicio' to match new field type.
        db.rename_column('historialprocedimientos_histogramaitem', 'inicio_id', 'inicio')
        # Changing field 'HistogramaItem.inicio'
        db.alter_column('historialprocedimientos_histogramaitem', 'inicio', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        # Removing index on 'HistogramaItem', fields ['inicio']
        db.delete_index('historialprocedimientos_histogramaitem', ['inicio_id'])


    def backwards(self, orm):
        # Adding index on 'HistogramaItem', fields ['inicio']
        db.create_index('historialprocedimientos_histogramaitem', ['inicio_id'])
        ...
        # Changing field 'HistogramaItem.estimado'
        db.alter_column('historialprocedimientos_histogramaitem', 'estimado', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'HistogramaItem.finalizado'
        db.alter_column('historialprocedimientos_histogramaitem', 'finalizado', self.gf('django.db.models.fields.BooleanField')())

        # Renaming column for 'HistogramaItem.inicio' to match new field type.
        db.rename_column('historialprocedimientos_histogramaitem', 'inicio', 'inicio_id')
        # Changing field 'HistogramaItem.inicio'
        db.alter_column('historialprocedimientos_histogramaitem', 'inicio_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['historialprocedimientos.DateTime']))
