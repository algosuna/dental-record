...
from ActividadesClinicas.models import HistoriaClinica, Odontograma, Tratamiento
from ActividadesClinicas.models import Diagnostico, Procedimiento
...
class HistoriaClinicaForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['eInflamatoriasnotopciones'].label='Enfermedades inflamatorias '
        ...
        self.fields['habitosHigienicosVest'].label='Hábitos higiénicos: En el vestuario'
        self.fields['habitosHigienicosCorp'].label='Corporales'
        self.fields['frecuenciaLavadoDental'].label='Con qué frecuencia se lava los dientes'
        self.fields['uxiliaresBucales'].label='Utiliza auxiliares de higiene bucal:'
        self.fields['consumodeGolosinas'].label='Consume golosinas u otro tipo de alimentos entre las comidas:'
        self.fields['gruposanguineo'].label='Grupo sanguíneo'
        self.fields['factorRh'].label='Factor Rh'
        self.fields['cartilladeVacunacion'].label='Cuenta con Cartilla de vacunación :'
        ...
        self.fields['sistemamusculoEsqueletico'].label='Sistema musculoesquelético'
        ...
        self.fields['difparaAbrirlaboca'] .label='Dificultad para abrir la boca'
        self.fields['dolorabertura'].label='Dolor a la abertura o movimientos de lateralidad'
...
class OdontogramaForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            ButtonHolder(
                    Submit('save', 'Guardar', css_class='odontograma-submit')

            )
        )
        self.fields['doctor'].label = 'M&eacute;dico '
        self.fields['diagnostico'].label = 'Diagnostico '
