...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tratamiento.nombreTratamiento'
        db.alter_column('ActividadesClinicas_tratamiento', 'nombreTratamiento', self.gf('django.db.models.fields.CharField')(max_length=150))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Tratamiento.nombreTratamiento'
        db.alter_column('ActividadesClinicas_tratamiento', 'nombreTratamiento', self.gf('django.db.models.fields.CharField')(max_length=30))
