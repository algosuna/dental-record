...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HistoriaClinica.caraAsimetria'
        db.alter_column('ActividadesClinicas_historiaclinica', 'caraAsimetria', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'HistoriaClinica.caraAsimetria'
        db.alter_column('ActividadesClinicas_historiaclinica', 'caraAsimetria', self.gf('django.db.models.fields.CharField')(max_length=20))
