...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Procedimiento.tratamiento'
        db.delete_column('ActividadesClinicas_procedimiento', 'tratamiento_id')

        # Deleting field 'Procedimiento.odontograma'
        db.delete_column('ActividadesClinicas_procedimiento', 'odontograma_id')

        # Adding M2M table for field tratamiento on 'Procedimiento'
        m2m_table_name = db.shorten_name('ActividadesClinicas_procedimiento_tratamiento')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('procedimiento', models.ForeignKey(orm['ActividadesClinicas.procedimiento'], null=False)),
            ('tratamiento', models.ForeignKey(orm['ActividadesClinicas.tratamiento'], null=False))
        ))
        db.create_unique(m2m_table_name, ['procedimiento_id', 'tratamiento_id'])
    ...
    def backwards(self, orm):
        # Adding field 'Procedimiento.tratamiento'
        db.add_column('ActividadesClinicas_procedimiento', 'tratamiento',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ActividadesClinicas.Tratamiento'], null=True),
                      keep_default=False)
        ...
        # Removing M2M table for field tratamiento on 'Procedimiento'
        db.delete_table(db.shorten_name('ActividadesClinicas_procedimiento_tratamiento'))
    ...
    models = {
        ...
        'ActividadesClinicas.procedimiento': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'odontograma': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['ActividadesClinicas.Odontograma']", 'null': 'True', 'symmetrical': 'False'}),
            'pieza': ('django.db.models.fields.IntegerField', [], {}),
            'tratamiento': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['ActividadesClinicas.Tratamiento']", 'null': 'True', 'symmetrical': 'False'})
        },
